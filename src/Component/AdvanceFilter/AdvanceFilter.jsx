...
import {
  default as DropdownSkinValorant,
  default as DropdownSkins,
} from "../DropdownSkins";
          ...
          <div className="tab-right">
            <div className="change-name">
              ...
              <Dropdown
                clearable
                onChange={(e) => {
                  dataSend("changeNameStatus", e.target.outerText);
                }}
                options={changeName}
                selection
                placeholder="None"
            ...
            <div className="choose-region">
              ...
              <Dropdown
                clearable
                onChange={(e) => {
                  dataSend("region", e.target.outerText);
                }}
            ...
            <div className="change-name">
              ...
              <Dropdown
                clearable
                onChange={(e) => {
                  dataSend("rank", e.target.outerText);
                }}
                options={rankValorant}
                selection
                placeholder="None"
              />
            </div>
            ...
            <div className="range-price">
              ...
              <div className="range-price-container">
                ...
                >
                  ...
                  <input
                    id="priceMin"
                    onChange={() => dataSend("else", "nothing")}
                    type="number"
                    name="minimum-price"
                  />
                  <Label>.00</Label>
      ...
      <div className="tab-right">
        <div className="game">
          ...
          <Dropdown
            ...
            value={GameValue}
            onChange={(e) => {
              dataSend("game", e.target.outerText);
              setGameValue(e.target.outerText);
            }}
            clearable
            options={game}
            selection
        ...
        <div className="change-name">
          ...
          <Dropdown
            clearable
            value={ChangeNameStatusValue}
            onChange={(e) => {
              dataSend("changeNameStatus", e.target.outerText);
              console.log(e.target.outerText);
              setChangeNameStatusValue(e.target.outerText);
            }}
            options={changeName}
            selection
            placeholder="None"
        ...
        <div className="choose-region">
          ...
          <Dropdown
            ...
            onChange={(e) => {
              dataSend("region", e.target.outerText);
              setRegionValue(e.target.outerText);
            }}
            options={chooseRegion}
            selection
            placeholder="None"
