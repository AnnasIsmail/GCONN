...
import DropdownAgentValorant from "../DropdownAgents";
import DropdownSkinValorant from "../DropdownSkins";
      ...
      <div className="left">
        <div>
          ...
          <Input
            ...
            id="header"
            autoComplete="off"
            onChange={(e) => changeValue(e, "header")}
          />
        </div>
        <div className="double-column dropdown-size">
          <div>
            ...
            <Dropdown
              ...
              placeholder="None"
              onChange={(e) => {
                setEmailStatusValue(e.target.outerText);
                data.emailStatus = e.target.outerText;
                changeValue(e, "email-status");
              }}
            />
          </div>
          <div>
            ...
            <Dropdown
              clearable
              id="chooseRegion"
              value={chooseRegionValue}
              options={chooseRegion}
              selection
              placeholder="None"
              onChange={(e) => {
                setChooseRegionValue(e.target.outerText);
                data.region = e.target.outerText;
                changeValue(e, "region");
              }}
            />
          </div>
        </div>
        <div className="double-column dropdown-size">
          <div>
            ...
            <Dropdown
              ...
              placeholder="None"
              onChange={(e) => {
                setRankValue(e.target.outerText);
                data.rank = e.target.outerText;
                changeValue(e, "rank");
              }}
            />
          </div>
          <div>
            <h6>Level</h6>
            <Input
              placeholder="Level Account"
              id="level"
              type="number"
              onChange={(e) => changeValue(e, "level")}
            />
          </div>
        </div>
        <div className="double-column dropdown-size">
          <div>
            <h6>Battlepass</h6>
            <Input
              placeholder="Battlepass"
              autoComplete="off"
              id="battlePass"
              onChange={(e) => changeValue(e, "battlepass")}
            />
          </div>
          <div className="format">
            ...
            <Input labelPosition="right" type="text" placeholder="Total VP">
              <input
                ...
                type="number"
                name="Total-VP"
                onChange={(e) => changeValue(e, "total-vp")}
              />
              <Label>VP</Label>
            </Input>
          </div>
        ...
        <div className="double-column dropdown-size">
          <div>
            ...
            <Dropdown
              ...
              placeholder="None"
              onChange={(e) => {
                setChangeNameValue(e.target.outerText);
                data.changeNameStatus = e.target.outerText;
                changeValue(e, "change-name-status");
              }}
            />
          </div>
          <div className="format">
        ...
        <div>
          ...
          <Input
            placeholder="Reason to Sell Product"
            autoComplete="off"
            id="reason"
            onChange={(e) => changeValue(e, "reason")}
          />
        </div>
      </div>
      <div className="right">
          ...
          <div>
            <Segment>
              ...
              <Button
                primary
                onClick={function () {
                  document.getElementById("inputAddImage").click();
                }}
              >
                {dataUpdate ? (
                  <input
