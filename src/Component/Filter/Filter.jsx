    ...
    return(
        <div className="filter">
            <div className="filterGame">
                ...
                <Dropdown className="dropdown-filter" value={gameValue} onChange={(e)=>gameFilterFunction(e.target.outerText)} clearable options={game} selection placeholder="All Game" />
            </div>
            <div className="min-price">
                ...
                <Input labelPosition='right' type='text' placeholder='Minimum Price'>
                    ...
                    <input type="number" id="minPriceFilter" onChange={()=>minPriceFilterFunction()} value={minPrice} name="minimum-price" />
                    <Label>.00</Label>
                </Input>
            </div>
            <div className="max-price">
                ...
                <Input labelPosition='right' type='text' placeholder='Maximum Price'>
                    <Label basic>Rp.</Label>
                    <input type="number" id="maxPriceFilter" onChange={()=>maxPriceFilterFunction()} value={maxPrice} name="maximum-price" />
                    <Label>.00</Label>
                </Input>
            </div>
            <div className="sortBy">
                <label htmlFor="game"  >SORT BY</label>
                <Dropdown className="dropdown-filter" value={sortBy} onChange={(e)=>sortByFunction(e.target.outerText)} clearable options={sort} selection placeholder="Not Be Sorting" />
            </div>
            <AdvanceFilterContainer data={data} sendData={saveData} dataFilter={props.dataFilter} />
        </div>
    );
}
