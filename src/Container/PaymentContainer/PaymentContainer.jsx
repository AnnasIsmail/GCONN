...
function PaymentContainer(){
    ...
    const PaymentType = [
        ...
        { key: 'Permata Virtual Account', text: 'Permata Virtual Account', value: 'Permata Virtual Account' },
        { key: 'BCA Virtual Account', text: 'BCA Virtual Account', value: 'BCA Virtual Account' },
        { key: 'Mandiri Bill Payment', text: 'Mandiri Bill Payment', value: 'Mandiri Bill Payment' },
        { key: 'BNI Virtual Account', text: 'BNI Virtual Account', value: 'BNI Virtual Account' },
        { key: 'BRI Virtual Account', text: 'BRI Virtual Account', value: 'BRI Virtual Account' },
      ]
    ...
    function goPayment(){
        ...
        if(payment !== 'Please Choose Payment' && payment !== ''){
            ...
            .then((res)=>{
                ...
                if(res.status === 200){
                    res.data.forEach((data)=>NavigateTo(`/detaiTransaksi${data._id}`))
                }
            ...
            :    
                <>
                    <div className="content-payment-container">
                            ...
                            :
                            <div>
                            <Produk  src={account.photo[0]} game={account.game} header={account.header} price={account.price} id={account.id} footer={false} click={false} />
                            ...
                            <Button animated='fade' onClick={goPayment}>
                                ...
                                :
                                    <Button.Content hidden ><FormatMoney money={totalPayment} /> with {payment}</Button.Content>
                                }
                            </Button>
                    </div>
                </>
