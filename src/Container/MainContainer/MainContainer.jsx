      ...
      {props.additionalClass === "home-main-container" ? (
        ...
        <div className={`main-container ${props.additionalClass}`}>
          ...
          <div className="container-market-main-container">
            {dataFilter ? (
              <ProdukFilterContainer
                goToChat={(data) => props.goToChat(data)}
                dataFilter={dataFilter}
                page={props.additionalClass}
              />
            ) : (
              <ProdukContainer
                goToChat={(data) => props.goToChat(data)}
        ...
        <div
          className={`main-container market-main-container ${props.additionalClass}`}
        >
          <ProdukContainer
            goToChat={(data) => props.goToChat(data)}
            page={props.additionalClass}
        ...
        props.additionalClass === "edit-account-main-container" ? (
        <div className={`main-container ${props.additionalClass}`}>
